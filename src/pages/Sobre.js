    ...
    return (
      <div className='container'>
        ...
        <p className='story-telling'>Atualmente,
          ...
          Meu sonho sempre foi trabalhar na área de tecnologia,
          hoje posso dizer que está sendo um começo de um sonho.
          Estou me realizando nos estudos com a TRYBE,
          alta qualidade na matéria que estudamos,
          didática de aulas ótimas, treinamentos de softkills,
          entre tantas coisas que realizamos durante o dia-a-dia.
          Espero aprender cada vez mais e que no futuro próximo estar
          exercendo na área!</p>
          </section>
      </div>
    );
